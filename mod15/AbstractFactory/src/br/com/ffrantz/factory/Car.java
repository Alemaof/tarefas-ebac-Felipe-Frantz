...
public abstract class Car {
    ...
    public void startEngine() {
        ...
        System.out.println("The " + fuelSource + " engine has been started, and is ready to use " + horsePower + " horsepower.");
    }
    ...
    public void fuelCar() {
        System.out.println("Car has been fueled with " + fuelSource.toLowerCase());
    }
}
