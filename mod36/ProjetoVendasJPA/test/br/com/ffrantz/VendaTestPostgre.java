...
public class VendaTestPostgre {
    ...
    public VendaTestPostgre() {
        vendaDAO = new VendaDAOPostgre();
        clienteDAO = new ClienteDAOPostgre();
        produtoDAO = new ProdutoDAOPostgre();
        vendaService = new VendaServicePostgre(vendaDAO);
    }
